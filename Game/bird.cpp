...
void VeGiaoDienVaoGame()
{
	...
	for (i = 1; i <= 40; i++)
	{
		...
		gotoXY(10, 9);
		cout << "   /  ___| |          _ _____  _ _____ _     _    | | ___ \\ _  ____   | | ";
		gotoXY(10, 10);
		cout << "  _| |__ | |     __ _| | ___ \\| | ___ \\ \\  / /    | |     /(_)/ ___| _| | ";
		gotoXY(10, 11);
		cout << " |_   __|| |    / _. | |___ _/| |___ _/\\ \\/ /     | |====<  _  /   / _. | ";
		gotoXY(10, 12);
		cout << "   | |   | |___| (_| | |      | |       \\/ /      | | ___ \\| | |  | (_| | ";
		gotoXY(10, 13);
		cout << "   |_|   |_____|\\__._|_|      |_|       /_/       |_|_____/|_|_|   \\__._| ";
		d++;
		gotoXY(100, 9);
		cout << "              __����������__";
		gotoXY(100, 10);
...
int main()
{
	...
	do
	{
			...
			while (1)
			{
				...
				if (yy == 8 - tocdo)
				{
					for (int i = 0; i < 6; i++)
					{
						...
						if (xv[i] == 1)
							Tang(xv[i], vitri[i], h[i], d[i], diem, 1);
						TextColor(14);
						gotoXY(50, 0);
		...
		case 2:
		{
			...
			cout << "Huong dan choi: ";
			gotoXY(47, 17);
			cout << "\t+ Dung phim w de bay len.";
			gotoXY(47, 18);
			cout << "\t+ Dung phim bat ki de bay xuong";
			getch();
			clrscr();
			break;
		}
